...
class LoginModule(private val fragment: LoginFragment) {
    ...
    @Provides
    fun vm(router: Router, sharedPrefsScreen: SharedPrefsScreen, networkConnectModel: NetworkConnectModel): ILoginViewModel =
        ViewModelProviders.of(fragment, object : ViewModelProvider.Factory {

        @Suppress("UNCHECKED_CAST")
        override fun <T : ViewModel?> create(modelClass: Class<T>) = LoginViewModel(router,
            sharedPrefsScreen, networkConnectModel) as T
